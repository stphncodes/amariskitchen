...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="wa-float fixed right-4 bottom-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] py-3 pr-5 pl-4 font-bold text-white shadow-2xl shadow-black/40 transition-transform hover:scale-105 sm:right-6 sm:bottom-6"
    >
