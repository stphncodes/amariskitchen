...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 items-center justify-center rounded-full border border-ink/20 text-ink transition-colors hover:border-brand-orange hover:text-brand-orange"
    >
      {theme === "dark" ? (
